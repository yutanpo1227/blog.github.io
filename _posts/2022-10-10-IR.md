...
![StoryBoard]({{site.baseurl}}/post-img/開発/IR/storyboard.png)
まずはボタンの配置をサクッと行い、ボタンを押した時にUDP通信を送信するように設定しました。</b>
...
M5Stackではスマホからの通信で送られてきた文字列によって適切な赤外線データを送信するという処理を実装しました。</b>
今回うちのエアコンは赤外線ユニットのライブラリにある機種ではなかったため予め読み取ったRawDataを送信しています。</b>
赤外線のRawDataの読み取りは、(こちらの記事)[https://qiita.com/coppercele/items/ed91646944ca28ff0c07]を参考にしました。</b>
...
実際に動作させたときの動画は(こちら)[https://twitter.com/yuu_gakusei/status/1579119524573769729]です。</b>

# まとめ

今回初めてSwiftでのアプリ開発をしてみた割に意外と思っていた動作を実現できてよかったです。</b>
